...
const makeProductImage = (title: string, accent = '#f16900') =>
  `data:image/svg+xml;utf8,${encodeURIComponent(`
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 600 560'>
    <defs>
      <linearGradient id='bg' x1='0' y1='0' x2='1' y2='1'>
        <stop offset='0%' stop-color='#fff7eb'/>
        <stop offset='100%' stop-color='#f7ead6'/>
      </linearGradient>
    </defs>
    <rect width='600' height='560' fill='url(#bg)'/>
    <circle cx='300' cy='230' r='130' fill='${accent}' fill-opacity='0.12'/>
    <circle cx='300' cy='230' r='84' fill='white' stroke='${accent}' stroke-width='10' stroke-opacity='0.5'/>
    <path d='M300 112 C332 158 388 194 388 252 C388 304 346 348 300 348 C254 348 212 304 212 252 C212 194 268 158 300 112 Z' fill='${accent}' fill-opacity='0.18'/>
    <text x='300' y='435' text-anchor='middle' fill='#4b2727' font-size='30' font-family='Georgia, serif' font-weight='700'>${title}</text>
    <text x='300' y='475' text-anchor='middle' fill='#8c7766' font-size='18' font-family='Arial, sans-serif'>Brindarani</text>
  </svg>
  `)}`;

// Fallback products keep the public shop populated when the deployed API is unavailable.
export const products: Product[] = [
  {
    id: 'fallback-maroon-silk-blend-saree',
    name: 'Maroon Silk Blend Saree with Golden Border',
    description: 'Elegant devotional wear for festivals and temple visits.',
    category: 'Clothing',
    subcategory: 'Sarees',
    sizes: [{ size: 'Free Size', price: 819, stock: 12 }],
    images: [makeProductImage('Silk Saree', '#8b2638')],
    isTrending: true,
    isLatest: true,
  ...
  {
    id: 'fallback-solid-grey-blackout-door-curtain',
    name: 'Solid Grey Blackout Door Curtain',
    description: 'Soft, graceful curtain for home and mandir spaces.',
    category: 'Clothing',
    subcategory: 'Home Furnishing',
    sizes: [{ size: 'Door', price: 649, stock: 10 }],
    images: [makeProductImage('Door Curtain', '#68717d')],
    isTrending: true,
    isLatest: false,
    isVrindavanSpecial: false,
    rating: 0,
  ...
  {
    id: 'fallback-shri-radha-printed-white-tshirt',
    name: 'Shri Radha Printed White T-Shirt',
    description: 'Comfortable daily wear with a devotional print.',
    category: 'Clothing',
    subcategory: 'T-Shirts',
    sizes: [{ size: 'M', price: 469, stock: 15 }],
    images: [makeProductImage('Radha T-Shirt', '#f16900')],
    isTrending: true,
    isLatest: true,
    isVrindavanSpecial: true,
    rating: 0,
    reviews: 0,
    createdAt: '2026-01-03T00:00:00.000Z',
  },
  {
    id: 'fallback-besan-laddu',
    name: 'Besan Laddu Prasadam Box',
    description: 'Traditional sweet prasadam for offerings and gifting.',
    category: 'Prasadam',
    subcategory: 'Sweets',
    sizes: [{ size: '500g', price: 365, stock: 20 }],
    images: [makeProductImage('Besan Laddu', '#d79a00')],
    isTrending: true,
    isLatest: false,
    isVrindavanSpecial: true,
    rating: 0,
  ...
  {
    id: 'fallback-decorative-pooja-thali',
    name: 'Colorful Decorative Pooja Thali Set',
    description: 'Bright pooja thali set for daily worship and festivals.',
    category: 'Incense',
    subcategory: 'Puja Thalis',
    sizes: [{ size: 'Set', price: 249, stock: 18 }],
    images: [makeProductImage('Pooja Thali', '#1f8b66')],
    isTrending: true,
    isLatest: true,
    isVrindavanSpecial: false,
    rating: 0,
  ...
  {
    id: 'fallback-beyond-birth-and-death',
    name: 'Beyond Birth and Death',
    description: 'Devotional reading for reflection and spiritual study.',
    category: 'Books',
    subcategory: 'Devotional Books',
    sizes: [{ size: 'Paperback', price: 45, stock: 25 }],
    images: [makeProductImage('Devotional Book', '#5b1f2b')],
    isTrending: true,
    isLatest: false,
    isVrindavanSpecial: false,
    rating: 0,
